...
from Dataset import PanoramaDataset, ToTensor, Normalize
...
if __name__ == '__main__':
    ...
    transformed_dataset = PanoramaDataset(in_dir='/home/sw/360VR+Inpainting/code/erp_inpainting/data/out_temp', transform=transforms)
