...
class FaceGenerator(BaseNetwork):
    def __init__(self, in_channels, out_channels, nker=64, norm="bnorm",relu=True, init_weights=True):
...
class WholeDis(BaseNetwork):
    def __init__(self, in_channels, nker=64, norm="bnorm",relu=True, init_weights=True):
